...
export default function IncomeForm() {
	...
	const { addBudget, categories } = useContext(AppContext);
	...
	function handleSubmit(e) {
		...
		if (Fields.description.length > 25) {
			...
			Swal.fire({
				icon: "error",
				title: "Oops...",
				text: "Description is too long, keep it under 25 characters",
				confirmButtonColor: "#25292D",
			});
		}
		if (flag === 0) {
			...
			<div className="flex flex-wrap gap-3 mb-3">
				...
				<div className={COL}>
					<div className="form-control">
						...
						<input
							type="text"
							placeholder="Mention something in less than 25 characters"
							name="description"
